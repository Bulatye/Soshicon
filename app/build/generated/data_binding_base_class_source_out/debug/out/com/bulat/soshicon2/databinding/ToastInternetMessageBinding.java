...
public final class ToastInternetMessageBinding implements ViewBinding {
  ...
  @NonNull
  public static ToastInternetMessageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ToastInternetMessageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.toast_internet_message, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ToastInternetMessageBinding bind(@NonNull View rootView) {
